...
if __name__ == "__main__":
    ...
    if args.data_type == 'regular':
        ...
        us_test = None
        dxs_test = jax.vmap(lambda x, t: jnp.gradient(x, t, axis=0))(xs_test, ts_test)
    elif args.data_type == 'synthetic':
        ts_test = data[..., 0]
        xs_test = data[..., 1:1+args.x_size]
        dxs_test = data[..., 1 + args.x_size:1 + 2 * args.x_size]
    ...
    for test_id in range(xs_test.shape[0]):
        plot_results_ode(ts_test[test_id], dxs_test[test_id], drift_est_test[test_id], drift_pred_test[test_id],
