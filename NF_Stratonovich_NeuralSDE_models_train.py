...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_blocks', type=int, default=1, help='num of realnvp')
    ...
    parser.add_argument('--act_norm', type=str2bool, default=True)
    ...
    parser.add_argument('--noise_type', type=str, default='one', choices=['one', 'diag', 'all', 'single'])
