...
if __name__ == "__main__":
    ...
    parser.add_argument('--patch_size', type=int, default=10, help='patch size for training NFNeuralSDE')
    ...
    parser.add_argument('--act_norm', type=str2bool, default=False)
    ...
    parser.add_argument('--diff_model', type=str, default='RealNVP')
    ...
    parser.add_argument('--noise_type', type=str, default='one', choices=['one', 'diag', 'single', 'all'])
