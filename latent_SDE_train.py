...
if __name__ == "__main__":
    ...
    job_name = f"LatentSDE_{data_type}_{data_name}_{model_name}_hdr_{args.hidden_size_drift}_ddr_{args.depth_drift}_hdf_{args.hidden_size_diff}_ddf_{args.depth_diff}_p{args.patch_size}"
